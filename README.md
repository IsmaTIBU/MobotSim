## This repository is a clone of the project I originally created in collaboration with my colleague [OlivierCrt](https://github.com/OlivierCrt/MobotSim), hosted in his repository.
